...
extern uint16_t gdate_Year, gdate_Mounth, gdate_Day, gdate_Day;
extern uint16_t pdate_Year, pdate_Mounth, pdate_Day, pdate_Day;
...
extern uint8_t uart_Flag, send_Flag;
extern long jalali_Calender[3];
extern long miladi_Calender[3];
extern uint8_t numarray[10];
extern uint16_t irRemote;
    ...
    extern uint8_t  amrap_Second;
    extern uint8_t  amrap_Minute;
