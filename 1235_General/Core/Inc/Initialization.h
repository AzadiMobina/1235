...
uint8_t Condition = 1;
    ...
    uint16_t gdate_Year = 0, gdate_Mounth = 0, gdate_Day = 0;
    uint16_t jdate_Year = 0, jdate_Mounth = 0, jdate_Day = 0;
    ...
    uint8_t  upTime_Second = 0;
    uint8_t upTime_Minute = 0;
    uint8_t upTime_Minute_Defult = 10;
    uint8_t dnTime_Second = 0;
    int     dnTime_Minute = 0;
    uint8_t dnTime_Minute_Defult = 10;
    uint8_t timer_TimeStarting = 0;
    uint8_t timer_Mode = 0;
    uint8_t timer_StartUp = 0;
    uint8_t timer_Run = 0;
